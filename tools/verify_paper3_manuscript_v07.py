...
MANUSCRIPT = REPO_ROOT / "docs" / "validation" / "paper3_nanogeant4" / "manuscript_nanogeant4_v07.md"
EXPECTED_FILENAME = "manuscript_nanogeant4_v07.md"

REQUIRED_PHRASES = {
    "version": "**Manuscript version:** v07",
...
def main() -> int:
    ...
    print("PASS: paper3 manuscript v07 verification succeeded")
